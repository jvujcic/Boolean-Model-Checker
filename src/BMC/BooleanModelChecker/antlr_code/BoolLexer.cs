// $ANTLR 2.7.7 (20060930): "BoolGrammar.g" -> "BoolLexer.cs"$
	...
	public 	class BoolLexer : antlr.CharScanner	, TokenStream
	 {
		...
		public BoolLexer(Stream ins) : this(new ByteBuffer(ins))
		{
		}
		
		public BoolLexer(TextReader r) : this(new CharBuffer(r))
		{
		}
		
		public BoolLexer(InputBuffer ib)		 : this(new LexerSharedInputState(ib))
		{
		}
		
		public BoolLexer(LexerSharedInputState state) : base(state)
		{
			initialize();
		}
		private void initialize()
		{
			...
			literals.Add("od", 32);
			literals.Add("if", 26);
			literals.Add("while", 30);
			literals.Add("end", 19);
			literals.Add("fi", 29);
			literals.Add("then", 27);
			literals.Add("decl", 12);
			literals.Add("else", 28);
			literals.Add("do", 31);
			literals.Add("assert", 33);
			literals.Add("print", 22);
			literals.Add("begin", 18);
			literals.Add("goto", 23);
			literals.Add("return", 24);
			literals.Add("skip", 21);
		}
	...
	public void mWS(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	{
		long[] data = { -1L, -2882303761517117441L, 0L, 0L};
		return data;
	}
